...
class PermitTesting extends React.Component {
  ...
  erc20Approve = async () => {
    ...
    const erc20Address = "0x2cce0a66D5D05E8200aaFFA4BA148B48fC22AC59"; //token contract address
    const erc20 = new web3.eth.Contract(erc20Abi.abi, erc20Address);
    ...
    return (
      <div>
        <Layout>
          ...
          <Button primary onClick={this.erc20Approve}>
            Approve Protocol Contract Address!
          </Button>
          <Button primary onClick={this.erc20Deposit}>
            Deposit To Protocol Contract Address!
          </Button>
        </Layout>
      </div>
    );
